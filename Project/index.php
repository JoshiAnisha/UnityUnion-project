...
<div class="side-menu">
    ...
    <div class="container">
        ...
        <div class="content-container">
            <p class="description">Why volunteering?</p>
            <div class="images-container">
                <div class="image-item">
                    <img src="volunteer12.jpg" alt="Image 1">
                    <p>The waste management Volunteering</p>
                    <a href="description1.html">learn more</a>
                </div>
                <div class="image-item">
                    <img src="volunteer3.jpg" alt="Image 2">
                    <p>Educating the children</p>
                    <a href="description2.html">learn more</a>
                </div>
                <div class="image-item">
                    <img src="whyvol.webp" alt="Image 3">
                    <p>Power of planting tree</p>
                    <a href="description3.html">learn more</a>
                </div>
            </div>
        </div>
        
        <div class="content-container">
            <p class="description">Benefits of Volunteering</p>
            <div class="images-container">
                <div class="image-item">
                    <img src="volunteer5.jpeg" alt="Benefit 1">
                    <p>Animal care Volunteering</p>
                    <a href="benefit1.html">learn more</a>
                </div>
                <div class="image-item">
                    <img src="volunteer7.jpg" alt="Benefit 2">
                    <p>Volunteering in Natural Disaster</p>
                    <a href="benefit2.html">learn more</a>
                </div>
                <div class="image-item">
                    <img src="volunteer4.jpg" alt="Benefit 3">
                    <p>Blood donation Volunteering</p>
                    <a href="benefit3.html">learn more</a>
                </div>
            </div>
        </div>
        <div class="compound">
            ...
            <div class="image-content">
                <img src="volunteer20.jpg" alt="Placeholder Image">
            </div>
        </div>
